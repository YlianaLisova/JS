...
// template2.2
// for (let i= 0; i < simpsons.length; i++) {
//     document.write(`<div style="margin: 15px; width: 700px; display: flex; flex-direction: column; align-items: center; justify-content: center">
// <h2 style="margin: 10px;">${simpsons[i].name}. ${simpsons[i].surname}. ${simpsons[i].age}</h2>
// <p style="padding: 10px">${simpsons[i].info}</p>
// <img style="width: 20%" src="${simpsons[i].photo}" alt="${simpsons[i].name}">
// </div>`)
// }
...
//     document.write(`<div style="display: flex; flex-direction: column; justify-content: center; align-items: center; border: 1px solid #aaa5ab">
// <h3 style="font-size: 24px">${products[i].title}. Price - ${products[i].price}</h3>
// <img style="width: 19%; margin: 10px;" src="${products[i].image}" alt="${products[i].title}">
// </div>`)
// }